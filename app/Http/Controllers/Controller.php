    ...
    public function getAllSPDataBySubcat(Request $request){
        ...
        try {
            ...
            if(@$token_status['status'] == '200'){
                ...
                $datas = SPDetailsByCatSubcat::select('sp_id as id','first_name','last_name','email','mobile','active','enabled','category_id')->where('package_id', $request->package_id)->where('active', '1')->where('enabled', '1')->groupBy('sp_id')->get();
