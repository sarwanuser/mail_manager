...
class SPPayment extends Model
{
    ...
    public function getSubscriptionDetails(){
        return $this->hasMany(Subscription::class, 'id','subscription_id')->with('getCartPackageDetails')->with('getTransactionDetails')->with('getAddressDetails')->with('getSPTransactionDetails');
    }
